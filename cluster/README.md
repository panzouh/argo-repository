...
| logging.loki.chart.version | string | `"3.6.0"` | Chart version |
...
| logging.loki.values.persitence.read | string | `"10Gi"` | Loki write PVC size, you will need to define a StorageClass in `default.storageClass` |
| logging.loki.values.persitence.write | string | `"50Gi"` | Loki write PVC size, you will need to define a StorageClass in `default.storageClass` |
